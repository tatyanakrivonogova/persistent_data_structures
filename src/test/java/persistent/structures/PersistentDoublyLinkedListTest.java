...
class PersistentDoublyLinkedListTest {
    ...
    @BeforeEach
    void setUp() {
        emptyList = new PersistentDoublyLinkedList<>();
        listWithElements = (PersistentDoublyLinkedList<Integer>) emptyList
            .createWithAdded(1)
            .createWithAdded(2)
            .createWithAdded(3);
    }
    ...
    void testAddElements() {
        PersistentDoublyLinkedList<Integer> list = (PersistentDoublyLinkedList<Integer>) emptyList.createWithAdded(10);
        assertFalse(list.isEmpty());
        assertEquals(1, list.size());
        assertTrue(list.containsElement(10));
        
        list = (PersistentDoublyLinkedList<Integer>) list.createWithAdded(20);
    ...
    void testRemoveElements() {
        PersistentDoublyLinkedList<Integer> list = (PersistentDoublyLinkedList<Integer>) listWithElements.createWithRemoved(2);
        assertEquals(2, list.size());
        assertTrue(list.containsElement(1));
        assertFalse(list.containsElement(2));
        assertTrue(list.containsElement(3));
        
        list = (PersistentDoublyLinkedList<Integer>) list.createWithRemoved(1);
        assertEquals(1, list.size());
        assertFalse(list.containsElement(1));
        assertTrue(list.containsElement(3));
        
        list = (PersistentDoublyLinkedList<Integer>) list.createWithRemoved(3);
    ...
    void testRemoveNonExistent() {
        PersistentDoublyLinkedList<Integer> original = listWithElements;
        PersistentDoublyLinkedList<Integer> modified = (PersistentDoublyLinkedList<Integer>) original.createWithRemoved(99);
    ...
    void testCreateEmpty() {
        PersistentDoublyLinkedList<Integer> empty = (PersistentDoublyLinkedList<Integer>) listWithElements.createEmpty();
    ...
    void testImmutableOperations() {
        PersistentDoublyLinkedList<Integer> list = listWithElements;
    ...
    void testEqualsAndHashCode() {
        PersistentDoublyLinkedList<Integer> sameElements = (PersistentDoublyLinkedList<Integer>) emptyList
            .createWithAdded(1)
            .createWithAdded(2)
            .createWithAdded(3);
        
        PersistentDoublyLinkedList<Integer> differentElements = (PersistentDoublyLinkedList<Integer>) emptyList
            .createWithAdded(4)
            .createWithAdded(5);
        ...
        // Different size
        PersistentDoublyLinkedList<Integer> smaller = (PersistentDoublyLinkedList<Integer>) emptyList.createWithAdded(1);
    ...
    void testSnapshot() {
        assertSame(listWithElements, listWithElements.snapshot());
    }
    ...
    void testToString() {
        ...
        PersistentDoublyLinkedList<String> stringList = (PersistentDoublyLinkedList<String>) new PersistentDoublyLinkedList<String>()
            .createWithAdded("a")
            .createWithAdded("b");
    ...
    void testPersistence() {
        PersistentDoublyLinkedList<Integer> original = listWithElements;
        PersistentDoublyLinkedList<Integer> modified = (PersistentDoublyLinkedList<Integer>) original.createWithAdded(4);
    ...
    void testAddMultipleElements(int count) {
        ...
        for (int i = 0; i < count; i++) {
            list = (PersistentDoublyLinkedList<Integer>) list.createWithAdded(i);
            expected.add(i);
        }
