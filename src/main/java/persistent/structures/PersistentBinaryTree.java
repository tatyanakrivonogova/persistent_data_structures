...
/**
 * Persistent binary search tree that fully implements Collection interface. Uses wrapper pattern
 * for transactional updates.
 *
 * @param <T> the type of elements, must be Comparable
 */
public class PersistentBinaryTree<T extends Comparable<T>> implements PersistentStructure<T> {
  ...
  public boolean add(T e) {
    ...
    throw new UnsupportedOperationException(
        "PersistentBinaryTree is immutable. Use TransactionalPersistentTree wrapper for mutable"
            + " operations.");
  }
