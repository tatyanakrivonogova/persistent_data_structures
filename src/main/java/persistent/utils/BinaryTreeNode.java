 ...
 * 
 * @param <T> the type of values stored in the node, must be Comparable for ordering
 * @version 1.0
 */
public class BinaryTreeNode<T extends Comparable<T>> {
     ...
     */
    public BinaryTreeNode<T> withValue(T newValue) {
     ...
     */
    public BinaryTreeNode<T> withLeft(BinaryTreeNode<T> newLeft) {
     ...
     */
    public BinaryTreeNode<T> withRight(BinaryTreeNode<T> newRight) {
    ...
    /**
     * Returns a string representation of this node in the format "Value[height]".
     * 
