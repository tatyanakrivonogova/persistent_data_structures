...
/**
 * Persistent structure that implements standard Collection interface
 * while maintaining immutability through versioning.
 *
...
public interface PersistentStructure<T> extends Collection<T> {
     ...
     * Used internally for persistent operations.
     *
